...
final Map<String, FormConfig> formCatalog = {
  ...
  'podcast_booking': FormConfig(
    id: 'podcast_booking',
    title: 'Book a Podcast Spot',
    description:
        'Tell us about your organization and your podcast topic. We will contact you to schedule your appearance.',
    fields: [
      FieldSpec(
        id: 'orgName',
        label: 'Organization Name',
      ...
      FieldSpec(
        id: 'podcastTopic',
        label: 'Podcast Topic / Focus Area',
        type: FieldType.text,
        validator: ValidatorSpec(required: true, minLength: 5),
      ),
      FieldSpec(
        id: 'speakerExpertise',
      ...
      FieldSpec(
        ...
        type: FieldType.text,
        hint: 'e.g., Next 2-4 weeks, mornings preferred',
        validator: ValidatorSpec(required: false),
      ),
      FieldSpec(
        id: 'website',
...
final List<LinkSpec> dashboardLinks = [
  ...
  LinkSpec(
    id: 'tile_initiatives',
    title: 'Initiatives',
    subtitle: 'Find out about our initiatives',
  ...
  'events': ItemListConfig(
    ...
    items: const [
      ...
      ListItemSpec(
        id: 'soul_of_soil',
        title: 'Soul Of Soil',
        linkUrl: 'https://www.example.com/soul-of-soil',
      ),
      ListItemSpec(
        id: 'world_water_day',
        title: 'World Water Day',
        linkUrl: 'https://www.worldwaterday.org',
      ),
      ListItemSpec(
        id: 'earth_day_2026',
        title: 'Earth Day 2026',
        linkUrl: 'https://www.earthday.org',
      ),
      ListItemSpec(
        id: 'regen_worldcup',
        title: 'Regen WorldCup',
        linkUrl: 'https://www.example.com/regen-worldcup',
      )
    ],
  )
};
